...
- _next: All 8 title batches + gap-fill round 1 DONE. Wiki = **110 entities** across 6 types. Remaining deferred (thin/pending): per-player MPL/MKL rosters with verified handles (loan churn); other Malaysian-presenting MKL Spring 2026 teams (Team HAQ/SLxDTE/CRIT VIP/Maqna/XDG/Blepcat/Twisted Minds — org nationality unverified); Asian Games 2026 results (after Sep–Oct 2026); rolling glossary/players as new verified facts land._
